...
export default function CampusLegend({ userRole, isUnlocked, unlockCode, setUnlockCode, onUnlock, onAddRoom }) {
    const canEdit = userRole === "admin" || userRole === "damien" || (userRole === "eleve" && isUnlocked);
